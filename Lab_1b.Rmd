...
mdl <- mgcv::gam(
  formula = present ~ s(BO_chlomean) + s(BO_sstmean) + 
    s(BO_bathymean) + s(BO_silicate) + s(BO_salinity) + s(BO_phosphate) + s(BO_ph) + s(BO_nitrate) + s(BO_dissox) + s(BO_damean) + s(lon) + s(lat), 
